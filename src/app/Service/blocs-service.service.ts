...
export class BlocsServiceService {
  ...
  AddBloc = "http://localhost:8005/addbloc";
  SupprimerBloc ="http://localhost:8005/bloc";
  UpdateBloc="http://localhost:8005/bloc/update";
  ShowBloc="http://localhost:8005/bloc";
  affecterChambresABloc="http://localhost:8005/bloc/affecterChambresABloc";
  affecterBlocAFoyer="http://localhost:8005/bloc/affecterBlocAFoyer";
  nbChambreParTypeEtBloc="http://localhost:8005"
  GetBlocById="http://localhost:8005/bloc";
  GetBlocByIdFoyer="http://localhost:8005/blocByIdFoyer"
  getBlocsNonAffecter="http://localhost:8005/getBlocsNonAffecter"
  AffecterBlocsAFoyer="http://localhost:8005/bloc/affecterBlocAFoyer";
  getBlocByNom="http://localhost:8005/getBlocByNom";
