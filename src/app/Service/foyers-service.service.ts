...
export class FoyersServiceService {
  ...
  id!:number;
    showAllF= "http://localhost:8005/Foyer";
    AjouterF="http://localhost:8005/addFoyer";
    SupprimerF="http://localhost:8005/Foyer";
    UpdateF = "http://localhost:8005/Foyer/update";
    getFoyerById="http://localhost:8005/Foyer";
    getSumBlocByFoyer="/Foyer/getSumBloc";
    getFoyerParTypeSexe="http://localhost:8005/Foyer/getFoyerParTypeSexe";
    getFoyerParTypeMixte="http://localhost:8005/Foyer/getFoyerParTypeMixte";
